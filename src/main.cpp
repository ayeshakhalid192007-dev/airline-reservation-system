 ...
 * Description: Integrates all domain classes and provides menu-driven interface
...
// Include all domain class headers
#include "Airline.h" // for Airline class
#include "Flight.h" // for Flight class
#include "Booking.h" // for Booking class
#include "Passenger.h" // for Passenger class
#include "Seat.h" // for Seat class
#include "User.h" // for User base class
#include "Admin.h" // for Admin derived class
#include "Customer.h" // for Customer derived class
#include "Payment.h" // for Payment base class
#include "CreditCardPayment.h" // for CreditCardPayment derived class
#include "CashPayment.h" // for CashPayment derived class
#include "PointsPayment.h" // for PointsPayment derived class

using namespace std; // use standard namespace

// Function prototypes for menu operations
void displayMainMenu(); // displays the main menu options
void viewAllFlights(Airline& airline); // displays all flights in the airline
void searchFlightsByRoute(Airline& airline); // searches flights by origin and destination
void bookSeat(Airline& airline); // handles seat booking process
void cancelBooking(Airline& airline); // handles booking cancellation
void viewBookingDetails(Airline& airline); // displays booking details and prints ticket
void displayFlightManifest(Airline& airline); // displays passenger manifest for a flight
void testUserHierarchy(); // demonstrates polymorphism with User hierarchy
void testPaymentMethods(); // demonstrates polymorphism with Payment hierarchy
void clearInputBuffer(); // clears the input buffer after invalid input
